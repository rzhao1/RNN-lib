...
tf.app.flags.DEFINE_string("max_enc_len", 30, "The largest number of words in encoder")
tf.app.flags.DEFINE_string("max_dec_len", 30, "The largest number of words in decoder")
